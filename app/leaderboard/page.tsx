    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#0a0f1e" }}>
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div
            className={`lb-cloud-pill ${cloudError ? "" : isCloudEnabled ? "lb-cloud-on" : "lb-cloud-off"}`}
            style={
              cloudError
                ? {
          ...
          >
            ...
            <span className="hidden sm:inline">
              {isCloudEnabled && !cloudError ? "Live" : "Local"}
            </span>
          </div>
        </div>
        ...
        {cloudError && (
          ...
          >
            <RefreshCw size={11} />
            <span>
              Khong ket noi cloud — hien thi du lieu cuc bo.{" "}
              <button
                onClick={handleRetry}
                style={{
                  background: "none",
        ...
        {user && (
          <div className="lb-me-banner">
            ...
            <span>
              Chao <strong>{user.displayName}</strong>! Kha nang thi cua ban se duoc ghi nhan ngay.
            </span>
          </div>
        )}
        ...
        {!loading && filtered.length > 0 && (
          <div className="lb-stats-bar">
            <div className="lb-stat-card">
              ...
              <div>
                <p className="lb-stat-value" style={{ color: "#60a5fa" }}>
                  {totalPlayers}
                </p>
            ...
            <div className="lb-stat-card">
              ...
              <div>
                <p className="lb-stat-value" style={{ color: "#34d399" }}>
                  {topScore}%
                </p>
            ...
            <div className="lb-stat-card">
              ...
              <div>
                <p className="lb-stat-value" style={{ color: "#22d3ee" }}>
                  {avgScore}%
                </p>
          ...
          <div className="lb-podium-section">
            <div className="lb-podium-row">
              ...
              <div className="lb-podium-card lb-podium-2">
                ...
                <p className="lb-podium-set">
                  {top3[1].setName.length > 16
                    ? top3[1].setName.slice(0, 16) + "..."
                    : top3[1].setName}
                </p>
              ...
              <div className="lb-podium-card lb-podium-1">
                ...
                <p className="lb-podium-set">
                  {top3[0].setName.length > 16
                    ? top3[0].setName.slice(0, 16) + "..."
                    : top3[0].setName}
                </p>
                <div className="lb-podium-score">
              ...
              <div className="lb-podium-card lb-podium-3">
                ...
                <p className="lb-podium-set">
                  {top3[2].setName.length > 16
                    ? top3[2].setName.slice(0, 16) + "..."
                    : top3[2].setName}
                </p>
                <div className="lb-podium-score">
                ...
                return (
                  ...
                  >
                    <div className="lb-tier-rank-wrap">
                      <span className="lb-tier-rank" style={{ color: tierColor }}>
                        #{rank}
                      </span>
                    ...
                    <div className="lb-tier-info">
                      ...
                      <p className="lb-tier-set">
                        {entry.setName.length > 28
                          ? entry.setName.slice(0, 28) + "..."
                          : entry.setName}
                      </p>
                    </div>
                    <div className="lb-tier-right">
                      <div
                        className="lb-tier-tier-badge"
                        style={{
          ...
          <div className="lb-my-rank-banner">
            ...
            <div className="lb-my-rank-info">
              <p className="lb-my-rank-name">
                ...
                <span className="lb-you-tag" style={{ marginLeft: 6, fontSize: "0.6rem" }}>
                  Ban
                </span>
              </p>
