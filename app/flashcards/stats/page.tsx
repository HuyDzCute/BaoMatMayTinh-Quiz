          ...
          {!hasAnyActivity ? (
            ...
            <>
              ...
              <section className="fc-heatmap-card">
                ...
                >
                  Đã ôn <b style={{ color: "#60a5fa" }}>{stats.totalReviews}</b> lượt trong tổng số{" "}
                  <b style={{ color: "#f1f5f9" }}>{activity.filter((a) => a.reviews > 0).length}</b>{" "}
                  ngày
                </p>
              </section>
                ...
                <section className="fc-stats-table">
                  ...
                  <table>
                    ...
                    <tbody>
                      {topRows.map((r) => {
                        const studiedPct =
                          r.total === 0 ? 0 : Math.round(((r.learning + r.known) / r.total) * 100);
                        return (
                          <tr key={r.id}>
                            <td>
                            ...
                            <td style={{ minWidth: 160 }}>
                              <div className="fc-bar">
                                <div className="fc-bar-fill" style={{ width: `${studiedPct}%` }} />
                              </div>
...
function StatCard({
  ...
  return (
    <div
      ...
      style={tone ? ({ ["--stat-glow" as string]: `${tone}33` } as React.CSSProperties) : undefined}
    >
