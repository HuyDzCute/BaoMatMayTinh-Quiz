...
function AudioPlayerMini({ src }: { src: string }) {
  ...
  return (
    ...
    >
      ...
      >
        {playing ? (
          <Pause size={12} style={{ color: "#60a5fa" }} />
        ) : (
          <Play size={12} style={{ color: "#60a5fa", paddingLeft: "2px" }} />
        )}
      </button>
      <input
        type="range"
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="his-title-group">
            ...
            <div>
              ...
              <p className="his-title-sub">{isCloud ? "Dong bo tuyen tinh" : "Du lieu cuc bo"}</p>
            </div>
          </div>
          {!loading && history.length > 0 && (
            <span className="his-count-badge">{history.length} lan thi</span>
          )}
        ...
        {user?.isAnonymous && !loading && !isCloud && (
          ...
          >
            ...
            <span>
              Lich su duoc luu cuc bo tren may nay.{" "}
              <button
                onClick={async () => {
                  playSfx("click");
                  try {
              ...
              de dong bo tren nhieu thiet bi.
            </span>
          </div>
        )}
        ...
        {cloudError && !user?.isAnonymous && (
          ...
          >
            ...
            <span>
              Khong ket noi duoc cloud — hien thi du lieu cuc bo.{" "}
              <button
                onClick={() => {
                  playSfx("click");
                  setLoading(true);
        ...
        {!isInitialLoading && history.length > 0 && (
          <div className="his-stats-bar">
            <div className="his-stat-item">
              ...
              <div>
                <p className="his-stat-value" style={{ color: "#22d3ee" }}>
                  {totalAttempts}
                </p>
            ...
            <div className="his-stat-item">
              ...
              <div>
                <p className="his-stat-value" style={{ color: "#34d399" }}>
                  {bestScore}%
                </p>
            ...
            <div className="his-stat-item">
              ...
              <div>
                <p className="his-stat-value" style={{ color: "#60a5fa" }}>
                  {avgScore}%
                </p>
            ...
            <div className="his-stat-item">
              <div
                className="his-stat-icon"
                style={{
                  background: bestTier ? `${bestTier.bg}` : "rgba(100,116,139,0.1)",
                  border: bestTier
                    ? `1px solid ${bestTier.border}`
                    : "1px solid rgba(100,116,139,0.25)",
                  color: bestTier ? bestTier.color : "#94a3b8",
                }}
              >
                <Award size={14} />
              </div>
              <div>
                <p
                  className="his-stat-value"
                  style={{ color: bestTier ? bestTier.color : "#94a3b8" }}
                >
                            ...
                            <div className="his-card-meta">
                              {item.speakingAnswers && item.speakingAnswers.some(Boolean) ? (
                                <>
                                  ...
                                  >
                                    <Mic size={10} />
                                    {item.speakingAnswers.filter(Boolean).length}/
                                    {item.totalQuestions} thu am
                                  </span>
                                  <span
                                    className="his-meta-chip"
                                    style={{
                          ...
                          <div className="his-card-detail">
                            ...
                            {item.speakingAnswers && item.speakingAnswers.some(Boolean) && (
                              ...
                              >
                                ...
                                >
                                  <Mic size={12} />
                                  Cac ban ghi am ({item.speakingAnswers.filter(Boolean).length}/
                                  {item.totalQuestions})
                                </p>
                                <div
                                  style={{ display: "flex", flexDirection: "column", gap: "6px" }}
                                >
                                  {item.speakingAnswers.map((audio, qi) =>
                                    audio ? (
                                      <div key={qi}>
                                        <p
                                          style={{
