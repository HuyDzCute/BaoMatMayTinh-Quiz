...
import { getAllMatchRecords, type MatchRecord } from "@/lib/match-storage";
...
export default function MatchPlayPage() {
  ...
  if (pairCount === null) {
    return (
      <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#0a0f1e" }}>
        ...
        <main className="flex-1 w-full px-4 py-8" style={{ maxWidth: "640px", margin: "0 auto" }}>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              {PAIR_OPTIONS.map((opt) => {
                ...
                return (
                  ...
                  >
                    <div className="text-lg font-bold">{actual} cặp</div>
                    <div
                    ...
                    {rec?.bestTimeMs !== undefined && (
                      <div className="text-[10px] mt-1 font-mono" style={{ color: "#f59e0b" }}>
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#0a0f1e" }}>
      ...
      <main className="flex-1 w-full px-4 py-8" style={{ maxWidth: "800px", margin: "0 auto" }}>
        {result ? (
          <MatchResult
            setName={set.name}
