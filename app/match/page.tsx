...
import { getAllFlashcardSets } from "@/lib/flashcards-storage";
import {
  getAllMatchRecords,
  formatMatchTime,
  getMatchLevelState,
      ...
      >
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-sm sm:text-base max-w-xl" style={{ color: "#94a3b8" }}>
              Nối <strong style={{ color: "#60a5fa" }}>thuật ngữ</strong> với{" "}
              <strong style={{ color: "#06b6d4" }}>định nghĩa</strong> tương ứng — càng nhanh càng
              tốt. Hoàn thành để ghi vào bảng kỷ lục cá nhân của bạn.
            </p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            <Pill icon={<BookOpen size={11} />} label={`${set.cards.length} thẻ`} />
                            ...
                            {!hydrated && <Pill label="Đang tải…" accent="#64748b" />}
                          </div>
                        </div>
                        <ChevronRight
                          size={18}
...
function Pill({ icon, label, accent }: { icon?: React.ReactNode; label: string; accent?: string }) {
