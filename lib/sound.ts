...
export type SfxName = "correct" | "wrong" | "click" | "complete" | "tick" | "flip";
...
// (Test-only helpers removed — project currently has no test suite. If tests
// are added later, re-introduce internal helpers without leaking into the
// public API surface.)
