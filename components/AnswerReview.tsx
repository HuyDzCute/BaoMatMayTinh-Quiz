                    ...
                    {q.type === "matching" || q.type === "summary" ? (
                      <div className="space-y-2">
                        {(q.matchItems ?? []).map((item, mi) => {
                          ...
                          const selOptLabel =
                            selOptIdx !== undefined ? (q.matchOptions?.[selOptIdx] ?? null) : null;
                          const correctLabel = q.matchCorrect?.[mi];
                          const isCorrect =
                            typeof selOptLabel === "string" &&
                            correctLabel !== undefined &&
                            selOptLabel.split(".")[0] === correctLabel;
                          return (
                            <div
                              key={mi}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-3">
                        {q.answers.map((ans, idx) => {
                          ...
                          const isSelected =
                            isMCQAnswered(answers[i]) && toChoiceIdx(answers[i]) === idx;
