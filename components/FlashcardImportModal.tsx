    ...
    <div className="fc-import-modal-bg" onClick={handleClose}>
      <div className="fc-import-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="fc-import-help">
          Mỗi dòng là một thẻ theo định dạng: <code>front,back,example</code> (cột{" "}
          <code>example</code> không bắt buộc). Dòng bắt đầu bằng
          <code> #</code> là comment. Dùng <code># name:</code> và <code># description:</code> để
          đặt tên set.
        </p>
        ...
        <div className="fc-import-file">
          ...
          />
          <label htmlFor="fc-import-file-input" className="fc-import-file-btn">
        ...
        <div className="fc-import-actions">
          ...
          <button type="button" className="fc-btn fc-btn-primary" onClick={handleSubmit}>
            <Upload size={13} />
            Import
          </button>
        </div>
