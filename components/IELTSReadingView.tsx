...
import { ArrowLeft, ArrowRight, Send, CheckCircle2, BookOpen, Home } from "lucide-react";
...
const fmt = (secs: number) => formatTime(Math.max(0, Math.min(secs, 60 * 100 - 1)));
...
export default function IELTSReadingView({
  ...
  const effectiveQuestions: Question[] = questions.length > 0 ? questions : [];
  ...
  const timerColor = totalSecs <= 60 ? "is-danger" : totalSecs <= 180 ? "is-warning" : "";
  ...
  const fallbackFromData = (() => {
    ...
    const byLabel = sets.sections.find((s) => passageLabel && s.name === passageLabel);
  ...
  const hasPassage =
    effectivePassage.trim().length > 0 &&
    ...
    return (
      <div className="ielts-page">
        ...
        <div
          ...
          style={{ margin: "32px auto", textAlign: "center", padding: "64px 32px", maxWidth: 540 }}
        >
          ...
          <button type="button" onClick={handleExitHome} className="ielts-exit-home-btn">
            <Home size={15} />
  ...
  try {
    if (
      currentQ &&
      (currentQ.type === "matching" || currentQ.type === "summary") &&
      selected !== "-1"
    ) {
  ...
  return (
    <div className="ielts-page">
          ...
          <div className="ielts-passage-header">
            ...
            <div
              style={{
                marginTop: "8px",
                padding: "4px 8px",
                background: "var(--ielts-accent-softer)",
          ...
          >
            {hasPassage ? (
              effectivePassage.split("\n\n").map((para, idx) => {
                ...
                if (trimmed.startsWith("READING PASSAGE") || trimmed.startsWith("READING")) {
                  return (
                    <p
                      key={idx}
                      style={{
        ...
        <main className="ielts-question-card">
          <div className="ielts-question-header">
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              {(() => {
                ...
                if (t === "matching")
                  return <span className="ielts-qtype-badge ielts-qtype-matching">Matching</span>;
                if (t === "summary")
                  return <span className="ielts-qtype-badge ielts-qtype-summary">Summary</span>;
          ...
          {currentQ && isMatching(currentQ) ? (
            <MatchingQuestion
              ...
              onSelect={(itemIdx, optIdx) => {
                playSfx("click");
                onSelectAnswer(itemIdx, optIdx);
              }}
            />
            ...
            <McqQuestion
              ...
              onSelect={(_itemIdx, optIdx) => {
                playSfx("click");
                onSelectAnswer(0, optIdx);
              }}
            />
          ) : (
            <div className="ielts-question-body">
          ...
          <div className="ielts-qnav">
            ...
            <div className="ielts-qnav-actions">
              ...
              {isLast ? (
                <button onClick={handleSubmitClick} className="ielts-btn ielts-btn-success">
      ...
      {showSubmitConfirm && (
        ...
        >
          <div
            className="ielts-intro-card"
            style={{
              maxWidth: 440,
              animation: "ieltsScorePop 0.4s cubic-bezier(0.22,1,0.36,1) both",
            }}
          >
