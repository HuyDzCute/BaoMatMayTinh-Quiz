...
const navLinks = (user: { isAnonymous: boolean } | null) =>
  [
    { href: "/chat", label: "Cộng đồng", Icon: MessageCircle },
    ...
    { href: "/game", label: "WordRun 3D", Icon: Gamepad2 },
  ].filter((link) => {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-2 sm:gap-3">
        ...
        <Link href="/" className="hdr-logo shrink-0">
          <div className="hdr-logo-avatar">
            <div className="hdr-logo-avatar-inner">
              <Image src="/profile-with-qr.png" alt="QTHTM" width={32} height={32} />
            </div>
          </div>
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <button
            ...
            onMouseLeave={(e) => {
              e.currentTarget.style.color = soundEnabled ? "#60a5fa" : "#64748b";
                        ...
                        <div className="hdr-auth-menu-header">
                          <div className="hdr-auth-user-info">
                            <div className="hdr-auth-user-avatar">
                              {user.photoURL ? (
                                <SafeAvatar
                                  ...
                                  width={40}
                                  height={40}
                                  fallback={<span>{user.displayName.charAt(0).toUpperCase()}</span>}
                                />
                              ) : (
                            ...
                            <div className="hdr-auth-user-text">
                              ...
                              {user.email && <p className="hdr-auth-menu-email">{user.email}</p>}
                            </div>
                          </div>
                          {user.isAnonymous && <span className="hdr-auth-badge">Khách</span>}
                        </div>
                        <button
                          onClick={async () => {
                            playSfx("click");
                            ...
                            onClick={async () => {
                              ...
                              try {
                                ...
                                if (
                                  ...
                                  logger.error("[Header] signInWithGoogle failed:", err);
                                  playSfx("wrong");
                                }
                              }
                            }}
