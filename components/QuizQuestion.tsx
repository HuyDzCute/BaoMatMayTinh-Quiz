...
export default function QuizQuestion({
  ...
  useEffect(() => {
    ...
    const selected =
      typeof selectedAnswer === "number" ? selectedAnswer : parseInt(selectedAnswer, 10);
  ...
  if (!question) {
    return (
      <div
        className="animate-fade-slide-up p-6 rounded-2xl text-center"
        style={{
