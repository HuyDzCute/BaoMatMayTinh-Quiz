        ...
        : result.percentage >= 70
          ...
          : result.percentage >= 60
            ...
            : result.percentage >= 50
              ...
              : "F";
  const gradeColor =
    result.percentage >= 80 ? "#10b981" : result.percentage >= 60 ? "#f59e0b" : "#ef4444";
        ...
        <p className="text-sm mb-8" style={{ color: "#94a3b8" }}>
          {isSpeaking ? (
            ...
            <>
              ...
              <strong style={{ color: "#f1f5f9" }}>{result.setName}</strong>
            </>
          )}
        </p>
        ...
        <div className="grid grid-cols-3 gap-3 max-w-md mx-auto mb-8">
          ...
          >
            ...
            <p
              ...
              style={{ color: "#10b981", fontFamily: "var(--font-jetbrains)" }}
            >
              {result.correctCount}
            </p>
          ...
          >
            ...
            <p
              className="text-2xl font-black"
              style={{ color: "#ef4444", fontFamily: "var(--font-jetbrains)" }}
            >
              {result.wrongCount}
            </p>
            <p className="text-xs mt-1" style={{ color: "#94a3b8" }}>
              {isSpeaking ? "Chưa thu" : "Sai"}
            </p>
          </div>
          <div
            className="p-4 rounded-xl text-center"
          ...
          >
            ...
            <p
              className="text-2xl font-black"
              style={{ color: "#06b6d4", fontFamily: "var(--font-jetbrains)" }}
            >
              {isSpeaking ? `${result.totalQuestions}` : `${result.percentage}%`}
            </p>
            <p className="text-xs mt-1" style={{ color: "#94a3b8" }}>
              {isSpeaking ? "Câu hỏi" : "Chính xác"}
            </p>
          </div>
        </div>
